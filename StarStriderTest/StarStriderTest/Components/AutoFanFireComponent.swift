...
public class AutoFanFireComponent:GKComponent {
    ...
    func fire(){
        ...
        let directions:[CGVector] = [CGVector(dx: -0.8, dy: 1), CGVector(dx: -0.4, dy: 1), CGVector(dx: 0, dy: 1), CGVector(dx: 0.4, dy: 1), CGVector(dx: 0.8, dy: 1)]
        ...
        for dir in directions {
            ...
            proj.addComponent(ProjectileLinearComponent(speed: 1050, direction: dir))
